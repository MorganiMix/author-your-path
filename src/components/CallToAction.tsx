    ...
    <section className="py-20 px-4 bg-gradient-to-br from-primary/5 via-background to-primary-light/5">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <Button size="lg" className="bg-gradient-to-r from-primary to-primary-light hover:from-primary-dark hover:to-primary text-primary-foreground px-8 py-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 text-lg">
            Get Started Now
            <ArrowRight className="ml-2 w-5 h-5" />
          </Button>
          <Button variant="outline" size="lg" className="border-primary text-primary hover:bg-primary/5 px-8 py-4 rounded-lg text-lg">
            Try Free Sample
          </Button>
        </div>
